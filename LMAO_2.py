...
def reset():
    ...
    textRohgan_Josh.config(state=DISABLED)
...
def receipt():
    ...
    if costofBreadvar.get() != '' or costofMain_Coursevar.get() != '' or costofdrinksvar.get() != '':
        ...
        if e_Rohgan_Josh.get() != '0':
            textReceipt.insert(END, f'Rohgan_Josh:\t\t\t{int(e_Rohgan_Josh.get()) * 800}\n\n')
        ...
        if costofMain_Coursevar.get() != '0 Rs':
            textReceipt.insert(END, f'Cost Of Main_Course\t\t\t{priceofMain_Course}Rs\n\n')
...
def totalcost():
    ...
    if var1.get() != 0 or var2.get() != 0 or var3.get() != 0 or var4.get() != 0 or var5.get() != 0 or \
        ...
        item24 = int(e_Rohgan_Josh.get())
        item25 = int(e_Chicken_Biryani.get())
        item26 = int(e_Mutton_Biryani.get())
        item27 = int(e_Veg_Biryani.get())

        priceofBread = (item1 * 10) + (item2 * 60) + (item3 * 100) + (item4 * 50) + (item5 * 40) + (item6 * 30) + (
                    item7 * 120) \
                      + (item8 * 100) + (item9 * 120)
        ...
        priceofMain_Course = (item19 * 400) + (item20 * 300) + (item21 * 500) + (item22 * 550) + (item23 * 450) + (
                    item24 * 800) \
...
def Rohgan_Josh():
    if var24.get() == 1:
        textRohgan_Josh.config(state=NORMAL)
        textRohgan_Josh.focus()
        textRohgan_Josh.delete(0, END)
    elif var24.get() == 0:
        textRohgan_Josh.config(state=DISABLED)
        e_Rohgan_Josh.set('0')
...
rightFrame = Frame(root, bd=15, relief=RIDGE, bg='black')
...
recieptFrame = Frame(rightFrame,
                     bd=4, relief=RIDGE, bg='black')
recieptFrame.pack()

buttonFrame = Frame(rightFrame,
                    bd=3, relief=RIDGE, bg='black')
buttonFrame.pack()
...
Mutton_Biryanicake = Checkbutton(Main_CourseFrame, text='Mutton_Biryani',
                            font=('arial', 18, 'bold'),
                            onvalue=1, offvalue=0,
                            variable=var26
...
Veg_Biryanicake = Checkbutton(Main_CourseFrame, text='Veg_Biryani',
                              font=('arial', 18, 'bold'),
                              onvalue=1, offvalue=0,
                              variable=var27
                              , command=Veg_Biryani)
...
textRohgan_Josh = Entry(Main_CourseFrame,
                    font=('arial', 18, 'bold'),
                    bd=7, width=6,
                    state=DISABLED,
                    textvariable=e_Rohgan_Josh)
textRohgan_Josh.grid(row=5, column=1)
